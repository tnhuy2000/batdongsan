					...
					@foreach($cms_chude as $value)
						<tr>
							...
							<td class="text-center">
								@if($value->TenChuDe!='Giới thiệu' && $value->TenChuDe!='Dự án')
									<a href="#sua" data-toggle="modal" data-target="#myModalEdit" onclick="getCapNhat({{ $value->ID }}, '{{ $value->TenChuDe }}', {{ $value->ThuTuHienThi }}); return false;"><i class="fal fa-edit"></i></a>
								@endif
							</td>
							<td class="text-center">
								@if($value->TenChuDe!='Giới thiệu' && $value->TenChuDe!='Dự án')
									<a href="#xoa" data-toggle="modal" data-target="#myModalDelete" onclick="getXoa({{ $value->ID }}); return false;"><i class="fal fa-trash-alt text-danger"></i></a>
								@endif
							</td>
