			...
			<table id="DataList" class="table table-bordered table-hover table-sm">
				<thead>
					<tr>
						...
						<th scope="col" width="35%">Liên kết</th>
						<th scope="col" width="5%" title="Thứ tự hiển thị">TT</th>
						<th scope="col" width="5%">O/F</th>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="ThuTuHienThi"><span class="badge badge-secondary">6</span> Thứ tự hiển thị</label>
